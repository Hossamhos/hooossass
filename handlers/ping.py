...
from config import BOT_USERNAME, SUPPORT_GROUP, PING_IMG, BOT_NAME, UPDATES_CHANNEL, OWNER_NAME
...
@Client.on_message(command(["ping", "repo", "anon", "alive", f"بينج"]]) & filters.group & ~filters.edited & ~filters.private)
